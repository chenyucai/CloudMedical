...
export default class DifficultConsolidateDetail extends Component {
  // 构造
  constructor( props ) {
    super( props );
    // 初始状态
        ...
        <ScrollView>
          <View style={{
            ...
            <View style={{
              ...
              <View style={{
                width: 60, height: 24, flexDirection: 'row', justifyContent: 'center', alignItems: 'center',
            ...
            <View style={{
              ...
              <View style={{
                width: 120, height: 24, flexDirection: 'row', justifyContent: 'center', alignItems: 'center',
          ...
          <View style={{
            width: width * 0.98, marginLeft: width * 0.01, borderRadius: 4, backgroundColor: '#fff',
            marginTop: 20,
          }}>
            <View style={{
              width: width * 0.98,
