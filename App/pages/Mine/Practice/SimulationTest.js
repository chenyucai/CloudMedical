            ...
            <View style={styles.container}>
                ...
                <ScrollView>
                    ...
                    <View style={{width: width - 70, marginLeft: 35, marginTop: 40}}>
                        <Text style={{color: 'red', fontSize: 12}}>{'确定后显示对错与得分情况'}</Text>
                        <Text style={{color: 'red', fontSize: 12}}>{'1-2秒后自动进入下一题,直到答完为止'}</Text>
                    </View>
                    <Text style={{textAlign: 'center', marginTop: 60, color: 'red'}}
                          onPress={() => this.setState({modalVisible: true})}>{'点击查看测试结束,获取奖励页'}</Text>
                </ScrollView>
        ...
        return (
            <View style={{
                ...
                <TouchableOpacity style={{
                    ...
                    <Image source={{uri: 'http://163.177.128.179:39241/5aa14f12a537330cf8b8e651f168e3de'}}
                           style={{width: 18, height: 18, marginRight: 10,}}/>
                    <Text style={{fontSize: 14, color: '#0fc83f'}}>返回继续练习</Text>
                </TouchableOpacity>
            </View>
        )
    }
