                ...
                <Image style={styles.imageViewStyle} source={{uri:'http://pic.58pic.com/58pic/15/15/35/08858PICGTF_1024.jpg'}}>
                    <View style={styles.headerViewStyle}>
                        ...
                        <TouchableOpacity activeOpacity={1} >
                            ...
                            <Text style={{marginTop:10,color:'white'}}>签名:</Text>
                        </TouchableOpacity>
                    ...
                    <View style={styles.headerBottomViewStyle}>
                        <View style={{alignItems:'center',justifyContent:'center',height:50,width:width,flexDirection:'row'}}>
                            <View style={[styles.textViewStyle,{borderRightWidth:1,borderRightColor:'white'}]}><Text style={{color:'white'}}>1000可用积分</Text></View>
                            <View style={styles.textViewStyle}><Text style={{color:'white'}}>200累计积分</Text></View>
                        </View>
                    </View>
                </Image>
